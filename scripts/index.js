...
//		// this.letterArr = ["a.PNG","b.PNG","c.PNG","d.PNG","e.PNG","f.PNG","g.PNG","h.PNG","i.PNG","j.PNG","k.PNG","l.PNG"];
//		this.letterLen = 5;
//		this.speed =5;
//		this.spans =[];
//		this.die = 10;
...
window.onload = function(){
	...
	for(var i=0;i<choose.length;i++){
		choose[i].onclick = function(){
			...
			games.new_gk.innerHTML =("第<img src='images/"+games.aa+".png'>关") ;
			for(var i=0;i<games.spans.length;i++){
				document.body.removeChild(games.spans[i]);
			}
